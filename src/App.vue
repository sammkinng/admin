        ...
        <aside id="sidebar" :class="isOpen ? 'translate-x-0 ease-in' : '-translate-x-full ease-out'"
            ...
            <div class="flex flex-col items-center flex-1 space-y-6">
                ...
                <nav class="flex flex-col items-center space-y-6">
                    ...
                    <a href="#" :class="$route.path.startsWith('/result') ? selectedClass : notSelectedClass">
                        <router-link to="/result">    <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path :class="['group-hover:stroke-blue-700',$route.path.startsWith('/result')?blueStroke:'']"
                            ...
                            <path :class="['group-hover:stroke-blue-700',$route.path === '/result'?blueStroke:'']" d="M13 2V9H20" stroke="#969CBA" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
                        </svg></router-link>
                    </a>
                </nav>
            ...
            <div class="flex justify-center py-5 border-t border-gray-600">
                <a href="#" class="p-2 transition-colors duration-300 rounded-lg group hover:bg-white">
                    <svg class="w-5 h-5 opacity-100 group-hover:stroke-blue-700 " viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button
                            ...
                            <div class="flex items-center md:-mx-2 ">
                                <div class="hidden md:mx-2 md:flex md:flex-col md:items-end md:leading-tight">
                                    <span class="font-semibold text-sm text-gray-800">Alok Sharma</span>
